...
export default function LoginPage() {
    ...
    return (
        <div className="w-full h-screen bg-[url(./loginbg.jpg)] bg-cover bg-center flex justify-end items-center px-10">
            ...
            <div className="w-[500px] h-[580px] backdrop-blur-xs  rounded-[30px] relative text-white gap-[20px] 
            flex flex-col items-center shadow-[0_-15px_30px_rgba(0,0,0,0.6)] justify-center">
                ...
                <button onClick={login} className="w-[350px] h-[40px] bg-red-600 rounded-xl text-white text-lg mt-5
                 hover:bg-red-700 transition-all duration-300 cursor-pointer">Login</button>

                 <button onClick={googleLogin} className="w-[350px] h-[40px] rounded-xl text-white text-lg mt-5
                  transition-all duration-300 cursor-pointer"> <img src="/GoogleLogo.png" className="w-[30px] h-[30px] absolute right-[280px] cursor-pointer"/>Google</button>

                 <p>Don't Have an account? <Link to="/signup" className="text-red-400">Sign Up</Link> from here</p>
                 <p><Link to="/forget" className="text-red-400">Forgot Password?</Link></p>
